...
The schema source of truth is `drizzle/schema.ts`. Local operator documentation is under `.codex/wip/` and is intentionally not a tracked deployment artifact.
